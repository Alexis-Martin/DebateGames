...
do
  local function stats(nb_tests, nb_players, nb_vertices, graph_fun, param)
    ...
    while nb_tests > 0 do
      ...
      if values_agg.max > 0.70 and not insane_dist then
        game:exportXml("../tests/stats/insane_game_" .. nb_players .. "_" .. nb_vertices .. ".xml", "all")
        game:exportTex("../tests/stats/insane_game_" .. nb_players .. "_" .. nb_vertices .. ".tex")
        insane_dist = true
      end
